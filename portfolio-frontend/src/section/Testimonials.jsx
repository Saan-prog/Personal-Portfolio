...
//             wi[800px] h-[800px] bg-primary/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"
//       />
...
//             What People Say
//           </span>
//           <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 animate-fade-in animation-delay-100 text-sescondary-foreground">
//             kind words from{" "}
...
//               </div>
//               <blockquote className="text-md md:text-xl font-medium leading-relaxed mb-8 pt-4">
...
//               <button
//                 onClick={previous}
//                 className="p-3 rounded-full glass hover:bg-primary/10 hover:text-traition-all"
//               >
//                 <ChevronLeft />
//               </button>
