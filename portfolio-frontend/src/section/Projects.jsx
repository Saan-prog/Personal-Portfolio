...
const projects = [
    {
        ...
        image: "/project1.jpg",
        tags: ["JavaScript", "HTML, CSS and Bootstrap", "NodeJS", "Express", "MongoDB"],
        link: "#",
        github: "https://github.com/Saan-prog/Ecommerce-Website---Node-",
    },
    {
        title: "Netflix - clone",
        description:
            "A responsive Netflix clone using HTML, CSS, and Bootstrap, recreating the layout and user interface of the popular streaming platform.",
        image: "/project2.jpg",
...
const Projects = () => {
    return (
        <section id="projects" className="py-32 relative overflow-hidden">
            ...
            <div className="absolute botton-1/4 left-0 w-64 h-64 bg-highlight/5 rounded-full blur-3xl" />
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  text-muted-foreground group-hover:text-primary
                   ...
                   group-hover:-translate-y-1 transition-all"/>
                     ...
                     {/* View All CTA */}
        <div className="text-center mt-12 animate-fade-in animation-delay-500 px-3 py-1.5">
